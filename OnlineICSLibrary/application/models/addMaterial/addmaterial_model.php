<?php
	class AddMaterial_model extends CI_Model
	{
		...
		function addThesis($title, $author, $subject, $status, $type, $accountnumber, $callnumber, $publicationdate, $numberofcopies, $thesisadviser)
		{
			$this->load->helper('url');
		...
		function addJournal($title, $author, $subject, $status, $type, $accountnumber, $callnumber, $publicationdate, $numberofcopies, $volume, $description)
		{
			$this->load->helper('url');
